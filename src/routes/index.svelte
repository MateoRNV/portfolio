...
<section class="flex">
    ...
    <section class="index__section">
        <h3>Experience</h3>
        <br>
        <p>More than a year of professional experience and several courses in new technologies</p>
        <ul>
            <li>Freelance: Jun 2021 | Current</li>
            <li>Courses with degree: 2021 | Current</li>
